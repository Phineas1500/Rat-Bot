...
api = tweepy.API(auth)
toReply = [
    "AltPhinny", "BadBoyHalo", "tommyinnit", "Ranboosaysstuff", "TubboLive",
    "JackManifoldTV", "tommyaltinnit", "quackity4k", "KarlJacobs_", "honkkarl",
    "GeorgeNotFound", "Quackity", "sapnap", "SaintsofGames", "GeorgeNootFound",
    "CptPuffy", "TubboTWO", "MrBeast", "Nihachu", "DropsByPonk", "billzo_",
    "TinaKitten", "Antfrost", "FoolishGamers", "Punztw", "Spifeyy", "dantdm",
    "Corpse_Husband", "ranaltboo", "NotAntfr0st", "tomsimons", "BoomerNA",
    "FundyLive"
]
tweetIDs = [
...
while a == 1:
    ...
    for tweet in tweets:
        ...
        filter = [
            ...
            "anyone affected", "rest in peace", "rip"
        ]
        for i in filter:
            if i in tweetWords:
                filterDetect = True
        ...
        if (repeatTweet == False and sentInTheHour == True
            ...
            if (x == 1):
                ...
                tweetStatus = "Beware, " + toReply[
                    b] + "! I'm a dangerous doggo"
            elif (x == 265):
            ...
            c = c + 1
            try:
                api.update_status(status=tweetStatus + " (" + str(x) + ") " +
                                  mediaLink,
